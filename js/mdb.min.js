...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
                ...
                for (var o = 0; i > o; o++) if (v.State.calls[o]) {
                    ...
                    for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                        ...
                        if (a(S)) {
                            ...
                            for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), k) if ("element" !== T) {
                                var M, I = k[T], P = p.isString(I.easing) ? v.Easings[I.easing] : I.easing;
                                if (1 === g) M = I.endValue; else {
                                    var A = I.endValue - I.startValue;
                                    if (M = I.startValue + A * P(g, d, A), !f && M === I.currentValue) continue
                                }
                                if (I.currentValue = M, "tween" === T) m = M; else {
                                    if (b.Hooks.registered[T]) {
                                        var _ = b.Hooks.getRoot(T), O = a(S).rootPropertyValueCache[_];
                                    ...
                                    b.Hooks.registered[T] && (a(S).rootPropertyValueCache[_] = b.Normalizations.registered[_] ? b.Normalizations.registered[_]("extract", null, D[1]) : D[1]), "transform" === D[0] && (C = !0)
                                }
                            }
            ...
            var x = function () {
                ...
                function r() {
                    function t(t) {
                        ...
                        if ("scroll" === M) {
                            var x, k, T, P = /^x$/i.test(c.axis) ? "Left" : "Top", A = parseFloat(c.offset) || 0;
                ...
                if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                    ...
                    if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(w)) {
                        w = {};
                        for (var T = f + 1; T < arguments.length; T++) p.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? p.isString(arguments[T]) || p.isArray(arguments[T]) ? w.easing = arguments[T] : p.isFunction(arguments[T]) && (w.complete = arguments[T]) : w.duration = arguments[T]
                    }
                    var M, I = {promise: null, resolver: null, rejecter: null};
    ...
    return function () {
        ...
        1: [function (t, e, i) {
            ...
            function h(t) {
                var e = t[0] / 60, i = t[1] / 100, n = t[2] / 100, o = Math.floor(e) % 6, a = e - Math.floor(e),
                    r = 255 * n * (1 - i), s = 255 * n * (1 - i * a), l = 255 * n * (1 - i * (1 - a));
                n *= 255;
                switch (o) {
                    case 0:
                        return [n, l, r];
            ...
            n._set("bar", {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: o.Rectangle, initialize: function () {
                        ...
                        var n = this, o = n.chart, r = n.getMeta(), s = n.getDataset(), l = t.custom || {},
                        ...
                        var n = this, o = t._model, a = n.getValueScale(), r = a.getBasePixel(), s = a.isHorizontal(),
                        ...
                        var e, i, n = this.chart, o = this.getIndexScale().options.stacked,
                            a = void 0 === t ? n.data.datasets.length : t + 1, r = [];
                        ...
                        var t, e, i = this.getIndexScale(), n = this.getStackCount(), o = this.index,
                            r = i.isHorizontal(), s = r ? i.left : i.top, l = s + (r ? i.width : i.height), c = [];
                        ...
                        var i, n, o, a, r, s, l = this.chart, c = this.getMeta(), u = this.getValueScale(),
                            d = l.data.datasets, h = u.getRightValue(d[t].data[e]), p = u.options.stacked, f = c.stack,
                            m = 0;
                        ...
                        var n = i.scale.options, o = "flex" === n.barThickness ? function (t, e, i) {
                                var n, o = e.pixels, a = o[t], r = t > 0 ? o[t - 1] : null,
                                    s = t < o.length - 1 ? o[t + 1] : null, l = i.categoryPercentage;
                            ...
                            }(e, i, n), r = this.getStackIndex(t, this.getMeta().stack),
            ...
            n._set("bubble", {
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: o.Point, update: function (t) {
                        ...
                        var i, n, o, r = this.chart, s = r.data.datasets[this.index], l = t.custom || {},
                            c = r.options.elements.point, u = a.options.resolve, d = s.data[e], h = {},
            ...
            n._set("doughnut", {
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    update: function (t) {
                        var e = this, i = e.chart, n = i.chartArea, o = i.options, r = o.elements.arc,
                            s = n.right - n.left - r.borderWidth, l = n.bottom - n.top - r.borderWidth,
                            c = Math.min(s, l), u = {x: 0, y: 0}, d = e.getMeta(), h = o.cutoutPercentage,
                            p = o.circumference;
                        if (p < 2 * Math.PI) {
                            var f = o.rotation % (2 * Math.PI),
                                ...
                                }, T = {width: .5 * (C.x - S.x), height: .5 * (C.y - S.y)};
                            c = Math.min(s / T.width, l / T.height), u = {x: -.5 * (C.x + S.x), y: -.5 * (C.y + S.y)}
                        }
                    ...
                    updateElement: function (t, e, i) {
                        var n = this, o = n.chart, r = o.chartArea, s = o.options, l = s.animation,
                            c = (r.left + r.right) / 2, u = (r.top + r.bottom) / 2, d = s.rotation, h = s.rotation,
                            p = n.getDataset(),
                            f = i && l.animateRotate ? 0 : t.hidden ? 0 : n.calculateCircumference(p.data[e]) * (s.circumference / (2 * Math.PI)),
                            m = i && l.animateScale ? 0 : n.innerRadius, g = i && l.animateScale ? 0 : n.outerRadius,
            ...
            n._set("line", {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    update: function (t) {
                        var i, n, o, r = this, s = r.getMeta(), l = s.dataset, c = s.data || [], u = r.chart.options,
                            d = u.elements.line, h = r.getScaleForId(s.yAxisID), p = r.getDataset(), f = e(p, u);
                    ...
                    updateElement: function (t, e, i) {
                        var n, o, r = this, s = r.getMeta(), l = t.custom || {}, c = r.getDataset(), u = r.index,
                            d = c.data[e], h = r.getScaleForId(s.yAxisID), p = r.getScaleForId(s.xAxisID),
                    ...
                    calculatePointY: function (t, e, i) {
                        var n, o, a, r = this.chart, s = this.getMeta(), l = this.getScaleForId(s.yAxisID), c = 0,
                            u = 0;
                    ...
                    draw: function () {
                        var t = this.chart, i = this.getMeta(), n = i.data || [], o = t.chartArea, r = n.length, s = 0;
            ...
            n._set("polarArea", {
                ...
                legend: {
                    labels: {
                        generateLabels: function (t) {
                            var e = t.data;
                            return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
                                var o = t.getDatasetMeta(0), r = e.datasets[0], s = o.data[n].custom || {},
                                    l = a.valueAtIndexOrDefault, c = t.options.elements.arc;
                                return {
                                    text: i,
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    linkScales: a.noop,
                    update: function (t) {
                        var e = this, i = e.chart, n = i.chartArea, o = e.getMeta(), r = i.options, s = r.elements.arc,
                    ...
                    updateElement: function (t, e, i) {
                        for (var n = this, o = n.chart, r = n.getDataset(), s = o.options, l = s.animation, c = o.scale, u = o.data.labels, d = n.calculateCircumference(r.data[e]), h = c.xCenter, p = c.yCenter, f = 0, m = n.getMeta(), g = 0; g < e; ++g) isNaN(r.data[g]) || m.data[g].hidden || ++f;
                        var v = s.startAngle, y = t.hidden ? 0 : c.getDistanceFromCenterForValue(r.data[e]),
                            b = v + d * f, x = b + (t.hidden ? 0 : d),
            ...
            n._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}}), e.exports = function (t) {
                t.controllers.radar = t.DatasetController.extend({
                    ...
                    linkScales: a.noop,
                    update: function (t) {
                        var e = this, i = e.getMeta(), n = i.dataset, o = i.data, r = n.custom || {},
                            s = e.getDataset(), l = e.chart.options.elements.line, c = e.chart.scale;
                    ...
                    updateElement: function (t, e, i) {
                        var n = this, o = t.custom || {}, r = n.getDataset(), s = n.chart.scale,
                            l = n.chart.options.elements.point, c = s.getPointPositionForValue(e, r.data[e]);
            ...
            e.exports = function (t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                    construct: function (e, i) {
                        ...
                        var r = s.acquireContext(e, i), l = r && r.canvas, c = l && l.height, u = l && l.width;
                        ...
                        var i = this, n = i.options, a = i.scales || {}, r = [],
                        ...
                        n.scales && (r = r.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var r = n.options, l = r.id, c = o.valueOrDefault(r.type, n.dtype);
                            e(r.position) !== e(n.dposition) && (r.position = n.dposition), s[l] = !0;
                            var u = null;
                            if (l in a && a[l].type === c) (u = a[l]).options = r, u.ctx = i.ctx, u.chart = i; else {
                                var d = t.scaleService.getScaleConstructor(c);
                                if (!d) return;
                                u = new d({id: l, type: c, options: r, ctx: i.ctx, chart: i}), a[u.id] = u
                            }
                        ...
                        if (!1 !== l.notify(i, "beforeRender")) {
                            ...
                            if (r && (void 0 !== n && 0 !== n || void 0 === n && 0 !== r.duration)) {
                                var c = new t.Animation({
                                    ...
                                    render: function (t, e) {
                                        var i = o.easing.effects[e.easing], n = e.currentStep, a = n / e.numSteps;
                                        t.draw(i(a), a, n)
                                    },
            ...
            e.exports = function (t) {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    removeHoverStyle: function (t, e) {
                        var i = this.chart.data.datasets[t._datasetIndex], o = t._index, a = t.custom || {},
                    ...
                    setHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], i = t._index, o = t.custom || {},
                            a = n.valueAtIndexOrDefault, r = n.getHoverColor, s = t._model;
            ...
            e.exports = function (t) {
                ...
                function r(t, n, o) {
                    var a = document.defaultView, r = t.parentNode, s = a.getComputedStyle(t)[n],
                        l = a.getComputedStyle(r)[n], c = i(s), u = i(l), d = Number.POSITIVE_INFINITY;
                ...
                a.configMerge = function () {
                    ...
                    var o = t.skip ? e : t, a = e, r = i.skip ? e : i,
                        ...
                        l = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), c = s / (s + l),
                        u = l / (s + l), d = n * (c = isNaN(c) ? 0 : c), h = n * (u = isNaN(u) ? 0 : u);
                    return {
                    ...
                    var i, n, o = t.originalEvent || t, r = t.currentTarget || t.srcElement,
                        s = r.getBoundingClientRect(), l = o.touches;
                    ...
                    var i = parseInt(a.getStyle(e, "padding-left"), 10),
                        n = parseInt(a.getStyle(e, "padding-right"), 10), o = e.clientWidth - i - n,
                    ...
                    var i = parseInt(a.getStyle(e, "padding-top"), 10),
                        n = parseInt(a.getStyle(e, "padding-bottom"), 10), o = e.clientHeight - i - n,
            ...
            e.exports = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        var r = t.options.layout || {}, s = n.options.toPadding(r.padding), l = s.left, c = s.right,
                            u = s.top, d = s.bottom, h = o(t.boxes, "left"), p = o(t.boxes, "right"),
                            f = o(t.boxes, "top"), m = o(t.boxes, "bottom"), g = o(t.boxes, "chartArea");
                        ...
                        var E = Math.max(T - A, 0);
                        A += E, _ += Math.max(M - _, 0);
                    ...
                    function V(t) {
                        ...
                        if (e) if (t.isHorizontal()) {
                            var i = {left: Math.max(A, T), right: Math.max(_, M), top: 0, bottom: 0};
            ...
            n._set("scale", {
                ...
                function i(t) {
                    var e = a.valueOrDefault, i = n.global, o = e(t.fontSize, i.defaultFontSize),
                ...
                t.Scale = o.extend({
                    ...
                    calculateTickRotation: function () {
                        var t = this, e = t.ctx, n = t.options.ticks, o = s(t._ticks), r = i(n);
                        e.font = r.font;
                        var l = n.minRotation || 0;
                        if (o.length && t.options.display && t.isHorizontal()) for (var c, u = a.longestText(e, r.font, o, t.longestTextCache), d = u, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > h && l < n.maxRotation;) {
                            var p = a.toRadians(l);
                            if (c = Math.cos(p), Math.sin(p) * u > t.maxHeight) {
                                l--;
                                break
                            }
                            l++, d = c * u
                    ...
                    fit: function () {
                        var t = this, n = t.minSize = {width: 0, height: 0}, o = s(t._ticks), l = t.options,
                            c = l.ticks, u = l.scaleLabel, d = l.gridLines, h = l.display, p = t.isHorizontal(),
                            f = i(c), m = l.gridLines.tickMarkLength;
                        if (n.width = p ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && d.drawTicks ? m : 0, n.height = p ? h && d.drawTicks ? m : 0 : t.maxHeight, u.display && h) {
                            var g = r(u) + a.options.toPadding(u.padding).height;
                            p ? n.height += g : n.width += g
                        }
                        if (c.display && h) {
                            var v = a.longestText(t.ctx, f.font, o, t.longestTextCache), y = a.numberOfLabelLines(o),
                                b = .5 * f.size, x = t.options.ticks.padding;
                            if (p) {
                                t.longestLabelWidth = v;
                                var w = a.toRadians(t.labelRotation), k = Math.cos(w),
                                    S = Math.sin(w) * v + f.size * y + b * (y - 1) + b;
                                n.height = Math.min(t.maxHeight, n.height + S + x), t.ctx.font = f.font;
                                var C = e(t.ctx, o[0], f.font), T = e(t.ctx, o[o.length - 1], f.font);
                                0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? k * C + 3 : k * b + 3, t.paddingRight = "bottom" === l.position ? k * b + 3 : k * T + 3) : (t.paddingLeft = C / 2 + 3, t.paddingRight = T / 2 + 3)
                            } else c.mirror ? v = 0 : v += x + b, n.width = Math.min(t.maxWidth, n.width + v), t.paddingTop = f.size / 2, t.paddingBottom = f.size / 2
                        }
                    ...
                    _autoSkip: function (t) {
                        var e, i, n, o, r = this, s = r.isHorizontal(), l = r.options.ticks.minor, c = t.length,
                            u = a.toRadians(r.labelRotation), d = Math.cos(u), h = r.longestLabelWidth * d, p = [];
                    ...
                    draw: function (t) {
                        ...
                        if (o.display) {
                            var s = e.ctx, c = n.global, u = o.ticks.minor, d = o.ticks.major || u, h = o.gridLines,
                                p = o.scaleLabel, f = 0 !== e.labelRotation, m = e.isHorizontal(),
                                g = u.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(),
                                v = a.valueOrDefault(u.fontColor, c.defaultFontColor), y = i(u),
                                b = a.valueOrDefault(d.fontColor, c.defaultFontColor), x = i(d),
                                w = h.drawTicks ? h.tickMarkLength : 0,
                                k = a.valueOrDefault(p.fontColor, c.defaultFontColor), S = i(p),
                                C = a.options.toPadding(p.padding), T = a.toRadians(e.labelRotation), M = [],
                            ...
                            if (a.each(g, function (i, n) {
                                if (!a.isNullOrUndef(i.label)) {
                                    ...
                                    n === e.zeroLineIndex && o.offset === h.offsetGridLines ? (r = h.zeroLineWidth, s = h.zeroLineColor, d = h.zeroLineBorderDash, p = h.zeroLineBorderDashOffset) : (r = a.valueAtIndexOrDefault(h.lineWidth, n), s = a.valueAtIndexOrDefault(h.color, n), d = a.valueOrDefault(h.borderDash, c.borderDash), p = a.valueOrDefault(h.borderDashOffset, c.borderDashOffset));
                                    var F = "middle", $ = "middle", W = u.padding;
                                    if (m) {
                                        var V = w + W;
                                        "bottom" === o.position ? ($ = f ? "middle" : "top", F = f ? "right" : "center", L = e.top + V) : ($ = f ? "middle" : "bottom", F = f ? "left" : "center", L = e.bottom - V);
                                        var z = l(e, n, h.offsetGridLines && g.length > 1);
                                        z < e.left && (s = "rgba(0,0,0,0)"), z += a.aliasPixel(r), E = e.getPixelForTick(n) + u.labelOffset, v = b = k = C = z, y = _, x = O, S = t.top, D = t.bottom + I
                                    } else {
                                        var N, H = "left" === o.position;
                                        u.mirror ? (F = H ? "left" : "right", N = W) : (F = H ? "right" : "left", N = w + W), E = H ? e.right - N : e.left + N;
                                        var j = l(e, n, h.offsetGridLines && g.length > 1);
                                        j < e.top && (s = "rgba(0,0,0,0)"), j += a.aliasPixel(r), L = e.getPixelForTick(n) + u.labelOffset, v = P, b = A, k = t.left, C = t.right + I, y = x = S = D = j
                                    }
                                    M.push({
                                        tx1: v,
                                        ty1: y,
                                ...
                                if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
                                    ...
                                    var i = t.label;
                                    if (a.isArray(i)) for (var n = i.length, o = 1.5 * y.size, r = e.isHorizontal() ? 0 : -o * (n - 1) / 2, l = 0; l < n; ++l) s.fillText("" + i[l], 0, r), r += o; else s.fillText(i, 0, 0);
                                    s.restore()
                                }
                            }), p.display) {
                                var D, E, L = 0, R = r(p) / 2;
                                if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - R - C.bottom : e.top + R + C.top; else {
                                    var F = "left" === o.position;
                                    D = F ? e.left + R + C.top : e.right - R - C.top, E = e.top + (e.bottom - e.top) / 2, L = F ? -.5 * Math.PI : .5 * Math.PI
                                }
                                s.save(), s.translate(D, E), s.rotate(L), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = k, s.font = S.font, s.fillText(p.labelString, 0, 0), s.restore()
                            }
                            if (h.drawBorder) {
                                s.lineWidth = a.valueAtIndexOrDefault(h.lineWidth, 0), s.strokeStyle = a.valueAtIndexOrDefault(h.color, 0);
                                var $ = e.left, W = e.right + I, V = e.top, z = e.bottom + I,
                                    N = a.aliasPixel(s.lineWidth);
                                m ? (V = z = "top" === o.position ? e.bottom : e.top, V += N, z += N) : ($ = W = "left" === o.position ? e.right : e.left, $ += N, W += N), s.beginPath(), s.moveTo($, V), s.lineTo(W, z), s.stroke()
                            }
                        }
                    }
                })
                ...
                t.Tooltip = o.extend({
                    initialize: function () {
                        ...
                        var t = this._options.callbacks, e = t.beforeTitle.apply(this, arguments),
                            n = t.title.apply(this, arguments), o = t.afterTitle.apply(this, arguments), a = [];
                        return a = i(a = i(a = i(a, e), n), o)
                    }, getBeforeBody: function () {
                        var t = this._options.callbacks.beforeBody.apply(this, arguments);
                        return a.isArray(t) ? t : void 0 !== t ? [t] : []
                    }, getBody: function (t, e) {
                        var n = this, o = n._options.callbacks, r = [];
                        return a.each(t, function (t) {
                        ...
                        var t = this._options.callbacks, e = t.beforeFooter.apply(this, arguments),
                            n = t.footer.apply(this, arguments), o = t.afterFooter.apply(this, arguments), a = [];
                        return a = i(a = i(a = i(a, e), n), o)
                    }, update: function (e) {
                        var i, n, o, s, l, c, u, d = this, h = d._options, p = d._model, f = d._model = r(h),
                            m = d._active, g = d._data, v = {xAlign: p.xAlign, yAlign: p.yAlign}, y = {x: p.x, y: p.y},
                            b = {width: p.width, height: p.height}, x = {x: p.caretX, y: p.caretY};
                        if (m.length) {
                            f.opacity = 1;
                            var w = [], k = [];
                            x = t.Tooltip.positioners[h.position].call(d, m, d._eventPosition);
                            var S = [];
                            for (i = 0, n = m.length; i < n; ++i) S.push((o = m[i], s = void 0, l = void 0, void 0, void 0, s = o._xScale, l = o._yScale || o._scale, c = o._index, u = o._datasetIndex, {
                            ...
                            h.filter && (S = S.filter(function (t) {
                                ...
                                var o = t.x, a = t.y, r = t.caretSize, s = t.caretPadding, l = t.cornerRadius,
                                    c = i.xAlign, u = i.yAlign, d = r + s, h = l + s;
                                ...
                                var i = t._chart.ctx, n = 2 * e.yPadding, o = 0, r = e.body,
                                    s = r.reduce(function (t, e) {
                                        return t + e.before.length + e.lines.length + e.after.length
                                    }, 0);
                                s += e.beforeBody.length + e.afterBody.length;
                                var l = e.title.length, c = e.footer.length, u = e.titleFontSize, d = e.bodyFontSize,
                                    h = e.footerFontSize;
                                ...
                                var i, n, o, a, r, s = t._model, l = t._chart, c = t._chart.chartArea, u = "center",
                                    d = "center";
                        ...
                        return f.xAlign = v.xAlign, f.yAlign = v.yAlign, f.x = y.x, f.y = y.y, f.width = b.width, f.height = b.height, f.caretX = x.x, f.caretY = x.y, d._model = f, e && h.custom && h.custom.call(d, f), d
                        ...
                        var n, o, a, r, s, l, c = i.caretSize, u = i.cornerRadius, d = i.xAlign, h = i.yAlign, p = t.x,
                            f = t.y, m = e.width, g = e.height;
                        ...
                        var r = i.xAlign, s = i.yAlign, l = t.x, c = t.y, u = o.width, d = o.height, h = i.cornerRadius;
            ...
            n._set("global", {
                ...
                draw: function () {
                    var t, e, i, n, o = this._view, s = this._chart.ctx, l = o.spanGaps, c = this._children.slice(),
                        u = r.elements.line, d = -1;
            ...
            n._set("global", {
                ...
                inRange: function (t, e) {
                    ...
                    var e = this._view, i = this._model, o = this._chart.ctx, s = e.pointStyle, l = e.radius, c = e.x,
                        u = e.y, d = a.color, h = 0;
            ...
            n._set("global", {
                ...
                draw: function () {
                    ...
                    if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, o = e > t ? 1 : -1, a = 1, r = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, o = 1, a = (n = l.base) > i ? 1 : -1, r = l.borderSkipped || "bottom"), c) {
                        var u = Math.min(Math.abs(t - e), Math.abs(i - n)), d = (c = c > u ? u : c) / 2,
                            h = t + ("left" !== r ? d * o : 0), p = e + ("right" !== r ? -d * o : 0),
                            f = i + ("top" !== r ? d * a : 0), m = n + ("bottom" !== r ? -d * a : 0);
            ...
            i = e.exports = {
                clear: function (t) {
                    ...
                    if (a) {
                        var r = Math.min(a, n / 2), s = Math.min(a, o / 2);
                        ...
                        if (!(isNaN(i) || i <= 0)) {
                            switch (e) {
                                default:
                                    ...
                                    break;
                                case"triangle":
                                    t.beginPath(), c = (r = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2, t.moveTo(n - r / 2, o + c / 3), t.lineTo(n + r / 2, o + c / 3), t.lineTo(n, o - 2 * c / 3), t.closePath(), t.fill();
                                    break;
                                case"rect":
                                    u = 1 / Math.SQRT2 * i, t.beginPath(), t.fillRect(n - u, o - u, 2 * u, 2 * u), t.strokeRect(n - u, o - u, 2 * u, 2 * u);
                                    break;
                                case"rectRounded":
                                    var d = i / Math.SQRT2, h = n - d, p = o - d, f = Math.SQRT2 * i;
                                    t.beginPath(), this.roundedRect(t, h, p, f, f, i / 2), t.closePath(), t.fill();
                                    break;
                                case"rectRot":
            ...
            "use strict";
            var n = t(45), o = "$chartjs", a = "chartjs-", r = a + "render-monitor", s = a + "render-animation",
            ...
            var r = {
                dataset: function (t) {
                    var e = t.fill, i = t.chart, n = i.getDatasetMeta(e),
                        o = n && i.isDatasetVisible(e) && n.dataset._children || [], a = o.length || 0;
            ...
            e.exports = {
                id: "filler", afterDatasetsUpdate: function (t, e) {
                    ...
                    var i = e.meta.$filler;
                    if (i) {
                        var o = t.ctx, r = i.el, s = r._view, l = r._children || [], c = i.mapper,
            ...
            var c = o.extend({
                initialize: function (t) {
                    ...
                    var t = this, e = t.options, i = e.labels, o = e.display, r = t.ctx, s = n.global,
                        c = a.valueOrDefault, u = c(i.fontSize, s.defaultFontSize),
                        d = c(i.fontStyle, s.defaultFontStyle), h = c(i.fontFamily, s.defaultFontFamily),
                    ...
                    var t = this, e = t.options, i = e.labels, o = n.global, r = o.elements.line, s = t.width,
                        c = t.lineWidths;
                    if (e.display) {
                        var u, d = t.ctx, h = a.valueOrDefault, p = h(i.fontColor, o.defaultFontColor),
                            f = h(i.fontSize, o.defaultFontSize), m = h(i.fontStyle, o.defaultFontStyle),
                            g = h(i.fontFamily, o.defaultFontFamily), v = a.fontString(f, m, g);
            ...
            var l = o.extend({
                ...
                beforeFit: s,
                fit: function () {
                    var t = this, e = a.valueOrDefault, i = t.options, o = i.display,
                        r = e(i.fontSize, n.global.defaultFontSize), s = t.minSize,
                        l = a.isArray(i.text) ? i.text.length : 1, c = a.options.toLineHeight(i.lineHeight, r),
                ...
                draw: function () {
                    ...
                    if (o.display) {
                        var s, l, c, u = i(o.fontSize, r.defaultFontSize), d = i(o.fontStyle, r.defaultFontStyle),
                            h = i(o.fontFamily, r.defaultFontFamily), p = a.fontString(u, d, h),
                            f = a.options.toLineHeight(o.lineHeight, u), m = f / 2 + o.padding, g = 0, v = t.top,
                ...
                var e = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var e = this, i = e.options.offset, n = Math.max(e._ticks.length - (i ? 0 : 1), 1),
                            o = e.isHorizontal(), a = (o ? e.width : e.height) / n;
            ...
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: a.formatters.linear}}, i = t.LinearScaleBase.extend({
                    determineDataLimits: function () {
            ...
            var n = t(45), o = t(34);
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: o.formatters.logarithmic}}, i = t.Scale.extend({
                    determineDataLimits: function () {
                        ...
                        var t = this, e = t.options.ticks, i = !t.isHorizontal(), o = {min: e.min, max: e.max},
                            a = t.ticks = function (t, e) {
                                var i, o, a = [], r = n.valueOrDefault,
                        ...
                        var i, o, a, r, s, l = this, c = l.options.ticks.reverse, u = n.log10,
                        ...
                        var i, o, a, r, s = this, l = s.options.ticks.reverse, c = n.log10,
                ...
                var p = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            var e, i, n, a = s(t), c = Math.min(t.height / 2, t.width / 2),
                                u = {r: t.width, l: 0, t: t.height, b: 0}, d = {};
                            t.ctx.font = a.font, t._pointLabelSizes = [];
                            var h, p, f, m = r(t);
                            for (e = 0; e < m; e++) {
                                n = t.getPointPosition(e, c), h = t.ctx, p = a.size, f = t.pointLabels[e] || "", i = o.isArray(f) ? {
                                    w: o.longestText(h, h.font, f),
                                    h: f.length * p + 1.5 * (f.length - 1) * p
                                } : {w: h.measureText(f).width, h: p}, t._pointLabelSizes[e] = i;
                                var g = t.getIndexAngle(e), v = o.toDegrees(g) % 360, y = l(v, n.x, i.w, 0, 180),
                        ...
                        var n = e.l / Math.sin(i.l), o = Math.max(e.r - this.width, 0) / Math.sin(i.r),
                            a = -e.t / Math.cos(i.t), r = -Math.max(e.b - this.height, 0) / Math.cos(i.b);
                        ...
                        var o = this, a = o.width - e - o.drawingArea, r = t + o.drawingArea, s = i + o.drawingArea,
                        ...
                        var t = this, i = t.options, n = i.gridLines, a = i.ticks, l = o.valueOrDefault;
                        if (i.display) {
                            var h = t.ctx, p = this.getIndexAngle(0), f = l(a.fontSize, e.defaultFontSize),
                                m = l(a.fontStyle, e.defaultFontStyle), g = l(a.fontFamily, e.defaultFontFamily),
                            ...
                            o.each(t.ticks, function (i, s) {
                                if (s > 0 || a.reverse) {
                                    ...
                                    if (n.display && 0 !== s && function (t, e, i, n) {
                                        ...
                                        if (h.font = v, h.save(), h.translate(t.xCenter, t.yCenter), h.rotate(p), a.showLabelBackdrop) {
                                            ...
                                            h.fillStyle = a.backdropColor, h.fillRect(-d / 2 - a.backdropPaddingX, -c - f / 2 - a.backdropPaddingY, d + 2 * a.backdropPaddingX, f + 2 * a.backdropPaddingY)
                                        }
                                ...
                                var i = t.ctx, n = t.options, a = n.angleLines, l = n.pointLabels;
                                i.lineWidth = a.lineWidth, i.strokeStyle = a.color;
                                var h = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max), p = s(t);
                                i.textBaseline = "top";
                                for (var f = r(t) - 1; f >= 0; f--) {
                                    ...
                                    if (l.display) {
                                        ...
                                        i.textAlign = c(b), d(b, t._pointLabelSizes[f], g), u(i, t.pointLabels[f] || "", g, p.size)
                                    }
                                }
                            }(t)
                        }
            ...
            var o = t(25), a = t(45), r = Number.MIN_SAFE_INTEGER || -9007199254740991,
            ...
            function h(t, e, i, n) {
                var o = function (t, e, i) {
                    ...
                    r = o.lo ? o.hi ? o.hi : t[t.length - 1] : t[1], s = r[e] - a[e], l = s ? (i - a[e]) / s : 0,
                    c = (r[n] - a[n]) * l;
                return a[n] + c
            }
            ...
            function f(t, e) {
                ...
                var i = e.options.time, n = p(e.getRightValue(t), i);
                return n.isValid() ? (i.round && n.startOf(i.round), n.valueOf()) : null
            }

            function m(t) {
                for (var e = c.indexOf(t) + 1, i = c.length; e < i; ++e) if (l[c[e]].common) return c[e]
            }

            function g(t, e, i, o) {
                var r, u = o.time, d = u.unit || function (t, e, i, n) {
                        var o, a, r, u = c.length;
                        for (o = c.indexOf(t); o < u - 1; ++o) if (r = (a = l[c[o]]).steps ? a.steps[a.steps.length - 1] : s, a.common && Math.ceil((i - e) / (r * a.size)) <= n) return c[o];
                        return c[u - 1]
                    }(u.minUnit, t, e, i), h = m(d), p = a.valueOrDefault(u.stepSize, u.unitStepSize),
                    f = "week" === d && u.isoWeekday, g = o.ticks.major.enabled, v = l[d], y = n(t), b = n(e), x = [];
                for (p || (p = function (t, e, i, n) {
                    ...
                    return r
                }(t, e, d, i)), f && (y = y.isoWeekday(f), b = b.isoWeekday(f)), y = y.startOf(f ? "day" : d), (b = b.startOf(f ? "day" : d)) < e && b.add(1, d), r = n(y), g && h && !f && !u.round && (r.startOf(h), r.add(~~((y - r) / (v.size * p)) * p, d)); r < b; r.add(p, d)) x.push(+r);
                return x.push(+r), x
            }
            ...
            e.exports = function (t) {
                var e = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, e, i, o, l, c, h = this, p = h.chart, m = h.options.time, g = m.unit || "day", v = s,
                            y = r, b = [], x = [], w = [];
                        for (t = 0, i = p.data.labels.length; t < i; ++t) w.push(f(p.data.labels[t], h));
                        for (t = 0, i = (p.data.datasets || []).length; t < i; ++t) if (p.isDatasetVisible(t)) if (l = p.data.datasets[t].data, a.isObject(l[0])) for (x[t] = [], e = 0, o = l.length; e < o; ++e) c = f(l[e], h), b.push(c), x[t][e] = c; else b.push.apply(b, w), x[t] = w.slice(0); else x[t] = [];
                        w.length && (w = d(w).sort(u), v = Math.min(v, w[0]), y = Math.max(y, w[w.length - 1])), b.length && (b = d(b).sort(u), v = Math.min(v, b[0]), y = Math.max(y, b[b.length - 1])), v = f(m.min, h) || v, y = f(m.max, h) || y, v = v === s ? +n().startOf(g) : v, y = y === r ? +n().endOf(g) + 1 : y, h.min = Math.min(v, y), h.max = Math.max(v + 1, y), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {
                            data: b,
                            datasets: x,
                            labels: w
                        }
                        ...
                        for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = f(u.min, o) || a, r = f(u.max, o) || r, t = 0, e = d.length; t < e; ++t) (i = d[t]) >= a && i <= r && v.push(i);
                        return o.min = a, o.max = r, o._unit = u.unit || function (t, e, i, o) {
                            var a, r, s = n.duration(n(o).diff(n(i)));
                            for (a = c.length - 1; a >= c.indexOf(e); a--) if (r = c[a], l[r].common && s.as(r) >= t.length) return r;
                            ...
                            for (i = 0; i < a; i++) {
                                if (0 !== (n = p(t[i], e)).millisecond()) return "MMM D, YYYY h:mm:ss.SSS a";
                                0 === n.second() && 0 === n.minute() && 0 === n.hour() || (o = !0)
                            }
                            return o ? "MMM D, YYYY h:mm:ss a" : "MMM D, YYYY"
                        }(o._timestamps.data, u), function (t, e) {
                            var i, o, a, r, s = [];
                        ...
                        return a.isObject(r) && (o = this.getRightValue(r)), n.tooltipFormat ? p(o, n).format(n.tooltipFormat) : "string" == typeof o ? o : p(o, n).format(this._labelFormat)
                    }, tickFormatFunction: function (t, e, i, n) {
                        var o = this.options, r = t.valueOf(), s = o.time.displayFormats, l = s[this._unit],
                            c = this._majorUnit, u = s[c], d = t.clone().startOf(c).valueOf(), h = o.ticks.major,
                            p = h.enabled && c && u && r === d, f = t.format(n || (p ? u : l)),
                            m = p ? h : o.ticks.minor, g = a.valueOrDefault(m.callback, m.userCallback);
                        return g ? g(f, e, i) : f
                        ...
                        var n = null;
                        if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = f(t, this)), null !== n) return this.getPixelForOffset(n)
                    }, getPixelForTick: function (t) {
                        var e = this.getTicks();
                        ...
                        var e = this.options.ticks, i = this.ctx.measureText(t).width, n = a.toRadians(e.maxRotation),
                        ...
                        var e = this, i = e.options.time.displayFormats.millisecond,
                            o = e.tickFormatFunction(n(t), 0, [], i), a = e.getLabelWidth(o),
                            r = e.isHorizontal() ? e.width : e.height, s = Math.floor(r / a);
                        return s > 0 ? s : 1
                    }
                });
            ...
            init: function () {
                ...
                function o(t) {
                    var e = t.getBoundingClientRect(), i = document.body, n = document.documentElement,
                        o = window.pageYOffset || n.scrollTop || i.scrollTop, a = n.clientTop || i.clientTop || 0,
                        r = e.top + o - a;
                    return Math.round(r)
                }
    ...
    "use strict";
    var t = t || {}, e = document.querySelectorAll.bind(document), i = Object.prototype.toString,
    ...
    var l = {
        ...
        input: function (t) {
            ...
            if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                ...
                var n = window.getComputedStyle(t, null), o = n.color, a = n.backgroundColor;
...
var _this = this;
(t => {
    const e = `${["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(t => `input[type=${t}]`).join(", ")}, textarea`,
        i = t => {
            const e = t.siblings("label, i"), i = t.val().length, n = t.attr("placeholder");
            ...
            const e = t(_this);
            if (e.val().length) {
                const i = t(".hiddendiv"), n = e.css("font-family"), o = e.css("font-size");
    ...
    t(e).each((e, n) => {
        const o = t(n), a = o.siblings("label, i");
        ...
        const i = t(e.target), o = !i.val(), a = !e.target.validity.badInput, r = void 0 === i.attr("placeholder");
        o && a && r && i.siblings("label, i").removeClass("active"), n(i)
    }), t(document).on("change", e, e => {
        const o = t(e.target);
        i(o), n(o)
    }), t("input[autofocus]").siblings("label, i").addClass("active"), t(document).on("reset", i => {
        const n = t(i.target);
        if (n.is("form")) {
            n.find(e).removeClass("valid").removeClass("invalid").each((e, i) => {
                const n = t(i), o = !n.val(), a = !n.attr("placeholder");
                o && a && n.siblings("label, i").removeClass("active")
            }), n.find("select.initialized").each((e, i) => {
                const n = t(i), o = n.siblings("input.select-dropdown"), a = n.children("[selected]").val();
                n.val(a), o.val(a)
            })
        }
    }), function () {
        const e = t(".md-textarea-auto");
        if (e.length) {
            let t;
    ...
    t(".materialize-textarea").each(o), a.on("keyup keydown", ".materialize-textarea", o)
})(jQuery), $(document).ready(() => {
    $("body").attr("aria-busy", !0), $("#preloader-markup").load("mdb-addons/preloader.html", () => {
        $(window).on("load", () => {
    ...
    t(document).on("click.card", ".card", function (e) {
        if (t(this).find(".card-reveal").length) {
            const i = t(e.target), n = i.is(".card-reveal .card-title"), o = i.is(".card-reveal .card-title i"),
                a = i.is(".card .activator"), r = i.is(".card .activator i");
    ...
    function e() {
        const e = Number(t(this).attr("length")), i = Number(t(this).val().length), n = i <= e;
        t(this).parent().find('span[class="character-counter"]').html(`${i}/${e}`), function (t, e) {
            const i = e.hasClass("invalid");
    ...
    t.fn.characterCounter = function () {
        return this.each(function () {
            void 0 !== t(this).attr("length") && (t(this).on("input", e), t(this).on("focus", e), t(this).on("blur", i), function (e) {
                const i = t("<span/>").addClass("character-counter").css("float", "right").css("font-size", "12px").css("height", 1);
                e.parent().append(i)
            }(t(this)))
        })
    }, t(document).ready(() => {
        ...
        return function () {
            ...
            function u(i) {
                ...
                if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
                    ...
                    o++, e = s(a, !0);
                    var l = null, u = t("<div/>"), p = t("<div/>"), f = t("<div/>"), m = t("<div/>"),
                        g = t(a.closeHtml), v = {intervalId: null, hideEta: null, maxHideTime: null},
...
$(".smooth-scroll").on("click", "a", function () {
    ...
    if (void 0 !== t && 0 === t.indexOf("#")) {
        const e = $(this).attr("data-offset") ? $(this).attr("data-offset") : 0,
            i = $(this).closest("ul").attr("data-allow-hashes");
        return $("body,html").animate({scrollTop: $(t).offset().top - e}, 700), void 0 !== i && !1 !== i && history.replaceState(null, null, t), !1
    }
}), function (t) {
    t.fn.scrollTo = function (e) {
        ...
        this.each(function () {
            const i = t(this), n = t.extend({}, t.fn.dropdown.defaults, e);
            let o = !1;
            const a = t(`#${i.attr("data-activates")}`);
            ...
            function s(e) {
                ...
                const s = window.innerHeight, l = i.innerHeight(), c = i.offset().left,
                    u = i.offset().top - t(window).scrollTop();
                let d = n.alignment, h = 0, p = 0, f = 0;
                !0 === n.belowOrigin && (f = l);
                let m = 0;
                const g = i.parent();
            ...
            function l() {
                o = !1, a.fadeOut(n.outDuration), a.removeClass("active"), i.removeClass("active"), setTimeout(() => {
                    a.css("max-height", "")
                }, n.outDuration)
            }
            ...
            if (r(), i.after(a), n.hover) {
                let e = !1;
                i.unbind(`click.${i.attr("id")}`), i.on("mouseenter", () => {
                    !1 === e && (s(), e = !0)
                }), i.on("mouseleave", i => {
                    const n = i.toElement || i.relatedTarget;
                    t(n).closest(".dropdown-content").is(a) || (a.stop(!0, !0), l(), e = !1)
                }), a.on("mouseleave", n => {
                    const o = n.toElement || n.relatedTarget;
                    t(o).closest(".dropdown-button").is(i) || (a.stop(!0, !0), l(), e = !1)
                })
            } else i.unbind(`click.${i.attr("id")}`), i.bind(`click.${i.attr("id")}`, e => {
                o || (i[0] !== e.currentTarget || i.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? i.hasClass("active") && (l(), t(document).unbind(`click.${a.attr("id")} touchstart.${a.attr("id")}`)) : (e.preventDefault(), s("click")), a.hasClass("active") && t(document).bind(`click.${a.attr("id")} touchstart.${a.attr("id")}`, e => {
                    a.is(e.target) || i.is(e.target) || i.find(e.target).length || (l(), t(document).unbind(`click.${a.attr("id")} touchstart.${a.attr("id")}`))
                }))
            });
            i.on("open", (t, e) => {
                s(e)
...
function dropdownEffectData(t) {
    let e = "fadeIn", i = "fadeOut";
    const n = $(t), o = $(".dropdown-menu", t), a = n.parents("ul.nav");
...
function dropdownEffectEnd(t, e) {
    t.dropdown.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", () => {
...
dropdownSelectors.on({
    "show.bs.dropdown"() {
        const t = dropdownEffectData(this);
        dropdownEffectStart(t, t.effectIn)
    }, "shown.bs.dropdown"() {
        const t = dropdownEffectData(this);
        t.effectIn && t.effectOut && dropdownEffectEnd(t)
    }, "hide.bs.dropdown"(t) {
        const e = dropdownEffectData(this);
        e.effectOut && (t.preventDefault(), dropdownEffectStart(e, e.effectOut), dropdownEffectEnd(e, () => {
    ...
    t(document).ready(() => {
        t(document).on("mouseenter", ".fixed-action-btn", function () {
            ...
            const n = t(this).parent();
            n.hasClass("active") ? e(n) : i(n), n.hasClass("active") ? i(n) : e(n)
        })
    }), t.fn.extend({
        openFAB() {
            e(t(this))
    ...
    const e = t => {
        ...
        if (!e.hasClass("active")) {
            e.addClass("active"), document.querySelectorAll("ul .btn-floating").forEach(t => {
                t.classList.add("shown")
            })
        }
    }, i = t => {
        t.removeClass("active"), document.querySelectorAll("ul .btn-floating").forEach(t => {
            t.classList.remove("shown")
        })
    };
    t(".fixed-action-btn > .btn-floating").on("click", n => (n.preventDefault(), function (t) {
        const n = t;
        n.hasClass("active") ? i(n) : e(n)
    }(t(".fixed-action-btn")), !1))
}(jQuery), function (t, e, i, n) {
    "use strict";
    var o, a = ["", "webkit", "Moz", "MS", "ms", "o"], r = e.createElement("div"), s = "function", l = Math.round,
        c = Math.abs, u = Date.now;
    ...
    var D = "ontouchstart" in t, E = A(t, "PointerEvent") !== n,
        L = D && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), R = 25, F = 1, $ = 2, W = 4, V = 8,
        z = 1, N = 2, H = 4, j = 8, B = 16, Y = N | H, X = j | B, q = Y | X, U = ["x", "y"], Q = ["clientX", "clientY"];
    ...
    var lt = {pointerdown: F, pointermove: $, pointerup: W, pointercancel: V, pointerout: V},
        ct = {2: "touch", 3: "pen", 4: "mouse", 5: "kinect"}, ut = "pointerdown",
    ...
    t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"), v(ht, Z, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = lt[n],
                a = ct[t.pointerType] || t.pointerType, r = "touch" == a, s = M(e, t.pointerId, "pointerId");
    ...
    var pt = {touchstart: F, touchmove: $, touchend: W, touchcancel: V}, ft = "touchstart",
    ...
    var vt = {touchstart: F, touchmove: $, touchend: W, touchcancel: V},
    ...
    var Ct = A(r.style, "touchAction"), Tt = Ct !== n, Mt = "auto", It = "manipulation", Pt = "none", At = "pan-x",
        _t = "pan-y", Ot = function () {
            if (!Tt) return !1;
    ...
    Dt.prototype = {
        set: function (t) {
            "compute" == t && (t = this.compute()), Tt && this.manager.element.style && Ot[t] && (this.manager.element.style[Ct] = t), this.actions = t.toLowerCase().trim()
        }, update: function () {
            ...
            if (this.manager.session.prevented) e.preventDefault(); else {
                ...
                if (!r || !a) return o || a && i & Y || r && i & X ? this.preventSrc(e) : void 0
            }
    ...
    Vt.prototype = {
        defaults: {}, set: function (t) {
            ...
            return -1 === M(e, t = Ht(t, this)) && (e.push(t), t.requireFailure(this)), this
        ...
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: q}, getTouchAction: function () {
            ...
            return t & Y && e.push(_t), t & X && e.push(At), e
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Y | X, pointers: 1},
        getTouchAction: function () {
            return Bt.prototype.getTouchAction.call(this)
        },
        attrTest: function (t) {
            var e, i = this.options.direction;
            return i & (Y | X) ? e = t.overallVelocity : i & Y ? e = t.overallVelocityX : i & X && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & W
        },
        emit: function (t) {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[qt, {enable: !1}], [Yt, {enable: !1}, ["rotate"]], [Ut, {direction: Y}], [Bt, {direction: Y}, ["swipe"]], [Qt], [Qt, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [Xt]],
        cssProps: {
    ...
    Kt.prototype = {
        set: function (t) {
            ...
            if (t = this.get(t)) {
                var e = this.recognizers, i = M(e, t);
    ...
    const e = 240, i = 1440, n = 2, o = .3, a = -.5, r = -.3, s = .5, l = 10;
            ...
            new class {
                constructor(i, n) {
                    this.defaults = {
                        ...
                        edge: "left",
                        closeOnClick: !1
                    }, this.$element = i, this.options = this.assignOptions(n), this.menuOut = !1, this.$body = t("body"), this.$menu = t(`#${this.$element.attr("data-activates")}`), this.$sidenavOverlay = t("#sidenav-overlay"), this.$dragTarget = t('<div class="drag-target"></div>'), this.$body.append(this.$dragTarget), this.init()
                }
                ...
                panEventHandler(t) {
                    if ("touch" !== t.gesture.pointerType) return;
                ...
                translateSidenavX(t) {
                    if ("left" === this.options.edge) {
                        const e = t >= this.options.MENU_WIDTH / n;
                        this.menuOut = e, this.$menu.css("transform", `translateX(${t - this.options.MENU_WIDTH}px)`)
                    } else {
                        const e = t < window.innerWidth - this.options.MENU_WIDTH / n;
                        this.menuOut = e;
                        let i = t - this.options.MENU_WIDTH / n;
                        i < 0 && (i = 0), this.$menu.css("transform", `translateX(${i}px)`)
                    }
                }
                ...
                buildSidenavOverlay() {
                    this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), this.$sidenavOverlay.css("opacity", 0).on("click", () => {
                        this.removeMenu()
                    }), this.$body.append(this.$sidenavOverlay)
                }

                disableScrolling() {
                    const t = this.$body.innerWidth();
                    this.$body.css("overflow", "hidden"), this.$body.width(t)
                }

                panendEventHandler(t) {
                    if ("touch" !== t.gesture.pointerType) return;
                    const e = t.gesture.velocityX, i = t.gesture.center.x;
                    let c = i - this.options.MENU_WIDTH, u = i - this.options.MENU_WIDTH / n;
                    c > 0 && (c = 0), u < 0 && (u = 0), "left" === this.options.edge ? (this.menuOut && e <= o || e < a ? (0 !== c && this.translateMenuX([0, c], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > o) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - l, c], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                        width: "10px",
                        right: "",
                        left: 0
                    })) : this.menuOut && e >= r || e > s ? (this.translateMenuX([0, u], "300"), this.showSidenavOverlay(), this.$dragTarget.css({
                        width: "50%",
                        right: "",
                        left: 0
                    })) : (!this.menuOut || e < r) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + l, u], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                        width: "10px",
                        right: 0,
                        left: ""
                    }))
                ...
                translateMenuX(t, e) {
                    this.$menu.velocity({translateX: t}, {
                ...
                openOnClick() {
                    this.$element.on("click", e => {
                        if (e.preventDefault(), !0 === this.menuOut) this.menuOut = !1, this.removeMenu(); else {
                            this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), this.$body.append(this.$sidenavOverlay);
                            let e = [];
                            e = "left" === this.options.edge ? [0, -1 * this.options.MENU_WIDTH] : [0, this.options.MENU_WIDTH], this.$menu.velocity({translateX: e}, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                ...
                closeOnClick() {
                    !0 === this.options.closeOnClick && this.$menu.on("click", "a:not(.collapsible-header)", () => {
                        this.removeMenu()
                    })
                }

                setMenuTranslation() {
                    "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({left: 0})) : (this.$menu.addClass("right-aligned").css("transform", "translateX(100%)"), this.$dragTarget.css({right: 0})), this.$menu.hasClass("fixed") && (window.innerWidth > i && this.$menu.css("transform", "translateX(0)"), t(window).resize(() => {
                        if (window.innerWidth > i) this.$sidenavOverlay.length ? this.removeMenu(!0) : this.$menu.css("transform", "translateX(0%)"); else if (!1 === this.menuOut) {
                            const t = "left" === this.options.edge ? "-100" : "100";
                            this.$menu.css("transform", `translateX(${t}%)`)
                        }
                    }))
                }

                setMenuWidth() {
                    const i = t(`#${this.$menu.attr("id")}`).find("> .sidenav-bg");
                ...
                removeMenu(t) {
                    this.$body.css({
                        ...
                        easing: "easeOutCubic",
                        complete: () => {
                            !0 === t && (this.$menu.removeAttr("style"), this.$menu.css("width", this.options.MENU_WIDTH))
                        }
    ...
    t.fn.collapsible = function (e) {
        ...
        return e = t.extend(i, e), this.each(function () {
            const i = t(this);
            let s = t(this).find("> li > .collapsible-header");
            const l = i.data("collapsible");
            i.off("click.collapse", ".collapsible-header"), s.off("click.collapse"), e.accordion || "accordion" === l || void 0 === l ? ((s = i.find("> li > .collapsible-header")).on("click.collapse", e => {
                let o = t(e.target);
                a(o) && (o = r(o)), o.toggleClass("active"), n(i, o)
            }), n(i, s.filter(".active").first())) : s.each(function () {
                t(this).on("click.collapse", e => {
                    let i = t(e.target);
    ...
    const e = "input[type=range]:not(.custom-range)";
    let i, n = !1;
    t(document).on("change", e, function () {
        ...
        const a = t(this), r = a.siblings(".thumb"), s = a.outerWidth();
        if (!r.length && function () {
            const i = t('<span class="thumb"><span class="value"></span></span>');
            t(e).after(i)
            ...
            const e = void 0 === o.pageX || null === o.pageX;
            (i = e ? o.originalEvent.touches[0].pageX - t(this).offset().left : o.pageX - t(this).offset().left) < 0 ? i = 0 : i > s && (i = s), r.addClass("active").css("left", i)
        }
        ...
        if (n) {
            o.hasClass("active") || o.velocity({
                ...
                duration: 300,
                easing: "easeOutExpo"
            }), a = void 0 === i.pageX || null === i.pageX ? i.originalEvent.touches[0].pageX - t(this).offset().left : i.pageX - t(this).offset().left;
            const n = t(this).outerWidth();
            a < 0 ? a = 0 : a > n && (a = n), o.addClass("active").css("left", a), o.find(".value").html(o.siblings(e).val())
        }
    }), t(document).on("mouseout touchleave", ".range-field", function () {
        if (!n) {
            const e = t(this).children(".thumb");
    ...
    t(document).on("change", '.file-field input[type="file"]', e => {
        const i = t(e.target), n = i.closest(".file-field").find("input.file-path"), o = i[0].files, a = [];
    ...
    class e {
        ...
        static clearMutationObservers() {
            e.mutationObservers.forEach(t => {
                t.disconnect(), t.customStatus = "stopped"
            })
        }

        init() {
            if (Boolean(this.$nativeSelect.data("select-id")) && this._removeMaterialWrapper(), "destroy" === this.options) return void this.$nativeSelect.data("select-id", null).removeClass("initialized");
            this.$nativeSelect.data("select-id", this.uuid), this.$selectWrapper.addClass(this.$nativeSelect.attr("class"));
            const t = this.$materialSelectInitialOption.replace(/"/g, "&quot;");
        ...
        _removeMaterialWrapper() {
            const e = this.$nativeSelect.data("select-id");
            this.$nativeSelect.parent().find("span.caret").remove(), this.$nativeSelect.parent().find("input").remove(), this.$nativeSelect.unwrap(), t(`ul#select-options-${e}`).remove()
        }
        ...
        renderMaterialSelect() {
            if (this.$nativeSelect.before(this.$selectWrapper), this.appendDropdownIcon(), this.appendMaterialSelect(), this.appendMaterialOptionsList(), this.appendNativeSelect(), this.appendSaveSelectButton(), this.$nativeSelect.is(":disabled") || this.$materialSelect.dropdown({
                hover: !1,
                closeOnClick: !1
            }), !1 !== this.$nativeSelect.data("inherit-tabindex") && this.$materialSelect.attr("tabindex", this.$nativeSelect.attr("tabindex")), this.isMultiple) this.$nativeSelect.find("option:selected:not(:disabled)").each((e, i) => {
                const n = t(i).index();
                this._toggleSelectedValue(n), this.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").eq(n).find(":checkbox").prop("checked", !0)
            }); else {
                const t = this.$nativeSelect.find("option:selected").index();
        ...
        appendSearchInputOption() {
            const e = this.$nativeSelect.attr("searchable");
            this.$searchInput = t(`<span class="search-wrap ml-2"><div class="md-form mt-0"><input type="text" class="search form-control w-100 d-block" placeholder="${e}"></div></span>`), this.$materialOptionsList.append(this.$searchInput)
        }
        ...
        buildMaterialOptions() {
            this.$nativeSelectChildren.each((e, i) => {
                const n = t(i);
                if (n.is("option")) this.buildSingleOption(n, this.isMultiple ? "multiple" : ""); else if (n.is("optgroup")) {
                    const e = t(`<li class="optgroup"><span>${n.attr("label")}</span></li>`);
                    this.$materialOptionsList.append(e), n.children("option").each((e, i) => {
                        this.buildSingleOption(t(i), "optgroup-option")
                    })
                }
            })
        }
        ...
        buildSingleOption(e, i) {
            const n = e.is(":disabled") ? "disabled" : "", o = "optgroup-option" === i ? "optgroup-option" : "",
                a = e.data("icon"), r = e.data("fa") ? `<i class="fa fa-${e.data("fa")}"></i>` : "",
                s = e.attr("class"), l = a ? `<img alt="" src="${a}" class="${s}">` : "",
        ...
        enableValidation() {
            this.$nativeSelect.css({
                ...
                padding: "0",
                "pointer-events": "none"
            }), -1 === this.$nativeSelect.attr("style").indexOf("inline!important") && this.$nativeSelect.attr("style", `${this.$nativeSelect.attr("style")} display: inline!important;`), this.$nativeSelect.attr("tabindex", -1), this.$nativeSelect.data("inherit-tabindex", !1)
        }

        bindEvents() {
            const i = new MutationObserver(this._onMutationObserverChange.bind(this));
            i.observe(this.$nativeSelect.get(0), {
                attributes: !0,
                childList: !0,
                characterData: !0,
                subtree: !0
            }), i.customId = this.uuid, i.customStatus = "observing", e.clearMutationObservers(), e.mutationObservers.push(i), this.$nativeSelect.parent().find("button.btn-save").on("click", this._onSaveSelectBtnClick), this.$materialSelect.on("focus", this._onMaterialSelectFocus.bind(this)), this.$materialSelect.on("click", this._onMaterialSelectClick.bind(this)), this.$materialSelect.on("blur", this._onMaterialSelectBlur.bind(this)), this.$materialSelect.on("keydown", this._onMaterialSelectKeydown.bind(this)), this.$toggleAll.on("click", this._onToggleAllClick.bind(this)), this.$materialOptionsList.on("mousedown", this._onEachMaterialOptionMousedown.bind(this)), this.$materialOptionsList.find("li:not(.optgroup)").not(this.$toggleAll).each((e, i) => {
                t(i).on("click", this._onEachMaterialOptionClick.bind(this, e, i))
        ...
        _onMutationObserverChange(i) {
            i.forEach(i => {
                const n = t(i.target).closest("select");
        ...
        _onEachMaterialOptionClick(e, i, n) {
            n.stopPropagation();
            const o = t(i);
            if (o.hasClass("disabled") || o.hasClass("optgroup")) return;
            let a = !0;
            if (this.isMultiple) {
                o.find('input[type="checkbox"]').prop("checked", (t, e) => !e);
                const t = Boolean(this.$nativeSelect.find("optgroup").length),
                    e = this._isToggleAllPresent() ? o.index() - 1 : o.index();
                a = this.isSearchable && t ? this._toggleSelectedValue(e - o.prevAll(".optgroup").length - 1) : this.isSearchable ? this._toggleSelectedValue(e - 1) : t ? this._toggleSelectedValue(e - o.prevAll(".optgroup").length) : this._toggleSelectedValue(e), this._isToggleAllPresent() && this._updateToggleAllOption(), this.$materialSelect.trigger("focus")
        ...
        _triggerChangeOnNativeSelect() {
            const t = new KeyboardEvent("change", {bubbles: !0, cancelable: !0});
        ...
        _onMaterialSelectFocus(e) {
            ...
            if (t("ul.select-dropdown").not(this.$materialOptionsList.get(0)).is(":visible") && t("input.select-dropdown").trigger("close"), !this.$materialOptionsList.is(":visible")) {
                ...
                const e = i.val(), n = this.$materialOptionsList.find("li").filter(function () {
        ...
        _onToggleAllClick() {
            const e = t(this.$toggleAll).find('input[type="checkbox"]').first(), i = !t(e).prop("checked");
            t(e).prop("checked", i), this.$materialOptionsList.find("li:not(.optgroup):not(.disabled):not(.select-toggle-all)").each((e, n) => {
                const o = t(n).find('input[type="checkbox"]');
                i && o.is(":checked") || !i && !o.is(":checked") || (this._isToggleAllPresent() && e++, o.prop("checked", i), this.$nativeSelect.find("option").eq(e).prop("selected", i), i ? t(n).removeClass("active") : t(n).addClass("active"), this._toggleSelectedValue(e), this._selectOption(n), this._setValueToMaterialSelect())
        ...
        _onMaterialSelectKeydown(e) {
            const i = t(e.target), n = e.which === this.keyCodes.tab, o = e.which === this.keyCodes.esc,
                a = e.which === this.keyCodes.enter, r = e.which === this.keyCodes.arrowUp,
                s = e.which === this.keyCodes.arrowDown, l = this.$materialOptionsList.is(":visible");
        ...
        _handleArrowDownKey() {
            const t = this.$materialOptionsList.find("li").not(".disabled").not(".select-toggle-all").first(),
        ...
        _handleLetterKey(e) {
            let i = "";
            const n = String.fromCharCode(e.which).toLowerCase(),
                o = Object.keys(this.keyCodes).map(t => this.keyCodes[t]);
            if (n && -1 === o.indexOf(e.which)) {
                i += n;
                const e = this.$materialOptionsList.find("li").filter(function () {
                    return -1 !== t(this).text().toLowerCase().indexOf(i)
                }).first();
        ...
        _onSearchInputKeyup(e) {
            const i = t(e.target), n = i.closest("ul"), o = i.val();
        ...
        _updateToggleAllOption() {
            const t = this.$materialOptionsList.find("li").not(".select-toggle-all, .disabled").find("[type=checkbox]"),
        ...
        _toggleSelectedValue(t) {
            const e = this.valuesSelected.indexOf(t), i = -1 !== e;
        ...
        _setValueToMaterialSelect() {
            let t = "";
            const e = this.valuesSelected.length;
            for (let i = 0; i < e; i++) {
                t += `, ${this.$nativeSelect.find("option").eq(this.valuesSelected[i]).text()}`
            }
            0 === (t = e >= 5 ? `${e} options selected` : t.substring(2)).length && (t = this.$nativeSelect.find("option:disabled").eq(0).text()), this.$nativeSelect.siblings("input.select-dropdown").val(t)
        }
    ...
    t.fn.materialSelect = function (i) {
    ...
    }, t.fn.material_select = t.fn.materialSelect, i = t.fn.val, t.fn.val = function (t) {
        if (!arguments.length) return i.call(this);
        if (!0 !== this.data("stop-refresh") && this.hasClass("mdb-select") && this.hasClass("initialized") && !this.hasClass("browser-default") && !this.hasClass("custom-select")) {
            e.clearMutationObservers(), this.materialSelect("destroy");
            const n = i.call(this, t);
            return this.materialSelect(), n
        }
        return i.call(this, t)
    }
}(jQuery), jQuery("select").siblings("input.select-dropdown").on("mousedown", t => {
    ...
    var e = t(window), i = t(document), n = t(document.documentElement),
        o = null != document.documentElement.style.transition;

    function a(e, l, u, d) {
        if (!e) return a;
        var h = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))},
            f = u ? t.extend(!0, {}, u.defaults, d) : d || {}, m = t.extend({}, a.klasses(), f.klass), g = t(e),
            v = function () {
                return this.start()
            }, y = v.prototype = {
    ...
    function o(t, e) {
        var i, n = this, o = t.$node[0], a = o.value, r = t.$node.data("value"), s = r || a,
            l = r ? e.formatSubmit : e.format, c = function () {
    ...
    o.prototype.set = function (t, e, i) {
        ...
        var a, r, s, l, c = this, u = i, d = o && o.interval ? o.interval : 1, h = -1 === c.item.enable, p = c.item.min,
            f = c.item.max, m = h && c.item.disable.filter(function (t) {
                if (e.isArray(t)) {
        ...
        var e, i, o = this, a = o.settings, r = o.item, s = r.now, l = r.select, c = r.highlight, u = r.view,
            d = r.disable, h = r.min, p = r.max,
            ...
            item: function (t) {
                ...
                return [n.group({
                    min: 7 * t - u.day + e + 1, max: function () {
                        ...
                        var e, i = l && l.pick == t.pick, r = c && c.pick == t.pick,
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var t = this.$root, e = this.get("highlight", "yyyy"), i = this.get("highlight", "dd"),
            n = this.get("highlight", "mmm"), o = this.get("highlight", "dddd");
    ...
    function C(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            p = r.find(".clockpicker-hours"), C = r.find(".clockpicker-minutes"),
            M = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), P = I ? t : t.find("input"),
            A = (P.prop("type"), n("label[for=" + P.attr("id") + "]")), _ = this;
        ...
        function V(t, i) {
            var n = l.offset(), o = /^touch/.test(t.type), r = n.left + v, c = n.top + v,
                u = (o ? t.originalEvent.touches[0] : t).pageX - r, p = (o ? t.originalEvent.touches[0] : t).pageY - c,
                f = Math.sqrt(u * u + p * p), m = !1;
            if (!i || !(f < y - x || f > y + x)) {
                t.preventDefault();
    ...
    C.DEFAULTS = {
        ...
        var e = this.currentView, i = this[e], n = "hours" === e, o = i * (Math.PI / (n ? 6 : 30)),
            a = n && i > 0 && i < 13 ? b : y, r = Math.sin(o) * a, l = -Math.cos(o) * a, c = this;
        ...
        var a, r, l = Math.atan2(t, -e), c = "hours" === this.currentView, u = Math.sqrt(t * t + e * e),
            d = this.options, h = c && u < (y + b) / 2, f = h ? b : y;
    ...
    return function (t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, T, M, I, P, A, _, O, D, E, L, R, F, $, W, V, z, N, H,
            j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {x: 0, y: 0}, ct = {x: 0, y: 0},
            ut = {x: 0, y: 0}, dt = {}, ht = 0, pt = {}, ft = {x: 0, y: 0}, mt = 0, gt = !0, vt = [], yt = {}, bt = !1,
            xt = function (t, e) {
                ...
                shout: Ct, listen: St, viewportSize: dt, options: r, isMainScrollAnimating: function () {
                    ...
                    if (!s && !l) {
                        var i;
                        a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, $ = o.detectFeatures(), O = $.raf, D = $.caf, P = $.transform, R = $.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                            ...
                            P = "left", o.addClass(t, "pswp--ie"), _t = function (t, e) {
                                ...
                                if (tt) {
                                    var t = tt, e = a.currItem, i = e.fitRatio > 1 ? 1 : e.fitRatio, n = i * e.w,
                                        o = i * e.h;
            ...
            }, Kt = {}, Gt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {x: 0, y: 0},
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                if (!("mousedown" === t.type && t.button > 0)) {
                    ...
                    if (!j || "mousedown" !== t.type) {
                        ...
                        Z = null, Ut(), B && 1 !== n || (B = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                            x: te.x,
                            y: te.y
                        }], V = W = Tt(), $t(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, X = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                    }
                }
            }, Ie = function (t) {
                ...
                if (B) {
                    var n = Ce(t);
                    if (it || q || K) Z = n; else if (ce.x !== ft.x * ht) it = "h"; else {
                ...
                if (Z) {
                    ...
                    if (0 !== t) if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                        ...
                        if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && g === a.currItem.initialZoomLevel) {
                            lt.y += Jt.y, ut.y += Jt.y;
                            var c = xe();
                            return H = !0, Ct("onVerticalDrag", c), Mt(c), void Pt()
                        }
                        (function (t, e, i) {
                            if (t - V > 50) {
                        ...
                        })(Tt(), Kt.x, Kt.y), q = !0, J = a.currItem.bounds, Te("x", Jt) || (Te("y", Jt), Lt(ut), Pt())
                    }
                }
            }, Ae = function (t) {
                if ($.isOldAndroid) {
                ...
                var c = -1;
                if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, q || X || et || H) if (Ut(), z || (z = _e()), z.calculateSwipeSpeed("x"), H) if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
        ...
        var Re, Fe, $e, We, Ve, ze, Ne = function (e, i, n, s) {
            ...
            var d = n ? r.hideAnimationDuration : r.showAnimationDuration, h = function () {
                Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Ct("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), We = !1
            };
            if (!d || !l || void 0 === l.x) return Ct("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Et(ut, e.initialPosition), Pt(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function () {
                h()
            }, d) : h());
            !function () {
                ...
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    } else g = e.initialZoomLevel, Et(ut, e.initialPosition), Pt(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Re = setTimeout(h, d + 20)
                }, n ? 25 : 90)
            }()
        }, He = {}, je = [], Be = {
            index: 0,
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(r, Be, !0), a.items = Fe = i, Ve = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), St("beforeChange", function (t) {
                        var e, i = r.preload, n = null === t || t >= 0, o = Math.min(i[0], ze()),
                            s = Math.min(i[1], ze());
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n)); else {
    ...
    return function (t, e) {
        ...
        x.init = function () {
            e.extend(t.options, C, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen, function () {
                ...
                S || _(), y && clearInterval(y), e.unbind(document, "mouseout", F), e.unbind(document, "mousemove", R), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
            }), d("destroy", function () {
        ...
        if (a = function (t) {
            ...
            galleryUID: e.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
                var e = a[t].el.getElementsByTagName("img")[0],
                    i = window.pageYOffset || document.documentElement.scrollTop, n = e.getBoundingClientRect();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    t.fn.sticky = function (e) {
        ...
        return this.each(function () {
            var e = t(this), a = e.outerHeight(), r = e.outerWidth(), s = i.topSpacing, l = i.zIndex,
                c = e.offset().top - s, u = t("<div></div>").width(r).height(a).addClass("sticky-placeholder"),
                d = i.stopper, h = t(window);
            ...
            (n.env.supportsTouch || n.env.supportsIePointer) && function (t, e, i, n) {
                ...
                function f(t) {
                    if (!w && e.settings.swipePropagation && p(t), !x && w && h(t)) {
                        var i = d(t), n = {pageX: i.pageX, pageY: i.pageY}, o = n.pageX - g.pageX,
                            a = n.pageY - g.pageY;
                        l(o, a), g = n;
    ...
    18: [function (t, e, i) {
        ...
        var o = t("../lib/helper"), a = t("../lib/class"), r = t("./default-setting"), s = t("../lib/dom"),
            l = t("../lib/event-manager"), c = t("../lib/guid"), u = {};
        i.add = function (t) {
            var e = c();
            return function (t, e) {
    ...
    19: [function (t, e, i) {
        ...
        var o = t("../lib/helper"), a = t("../lib/class"), r = t("../lib/dom"), s = t("./instances"),
            l = t("./update-scroll");
        e.exports = function (t) {
            var e, i = s.get(t);
    ...
    t(document).ready(() => {
        ...
        return this.$el = t(this), this.$document = t(document), this.eventsHandled = !1, this.defaultOptions = {
            ...
            arrowLeft: 37,
            arrowRight: 39
        }, "data" === e ? this.$el.data("chips") : "options" === e ? this.$el.data("options") : (this.$el.data("options", t.extend({}, this.defaultOptions, e)), this.init = (() => {
            this.$el.each((e, i) => {
                const n = t(i);
                if (n.data("initialized")) return;
                const o = n.data("options");
                o.data && Array.isArray(o.data) || (o.data = []), n.data("chips", o.data), n.data("index", e), n.data("initialized", !0), n.hasClass(this.selectors.chips) || n.addClass("chips"), this.renderChips(n)
            })
        }), this.handleEvents = function () {
            this.$document.on("click", this.selectors.chips, e => {
                t(e.target).find(this.selectors.input).focus()
            }), this.$document.on("click", this.selectors.chip, e => {
                t(this.selectors.chip).removeClass("selected"), t(e.target).addClass("selected")
            }), this.$document.on("keydown", e => {
                if (t(e.target).is("input, textarea")) return;
                const i = this.$document.find(this.selectors.chip + this.selectors.selectedChip),
                    n = i.closest(this.selectors.chips), o = i.siblings(this.selectors.chip).length;
                if (!i.length) return;
                const a = e.which === this.keyCodes.backspace, r = e.which === this.keyCodes.delete,
                    s = e.which === this.keyCodes.arrowLeft, l = e.which === this.keyCodes.arrowRight;
                a || r ? (e.preventDefault(), this.deleteSelectedChip(n, i, o)) : s ? this.selectLeftChip(n, i) : l && this.selectRightChip(n, i, o)
            }), this.$document.on("focusin", `${this.selectors.chips} ${this.selectors.input}`, e => {
                t(e.target).closest(this.selectors.chips).addClass("focus"), t(this.selectors.chip).removeClass("selected")
            }), this.$document.on("focusout", `${this.selectors.chips} ${this.selectors.input}`, e => {
                t(e.target).closest(this.selectors.chips).removeClass("focus")
            }), this.$document.on("keydown", `${this.selectors.chips} ${this.selectors.input}`, e => {
                const i = t(e.target), n = i.closest(this.selectors.chips), o = n.data("index"),
                    a = n.children(this.selectors.chip).length;
                if (e.which === this.keyCodes.enter) return e.preventDefault(), this.addChip(o, {tag: i.val()}, n), void i.val("");
                const r = e.keyCode === this.keyCodes.arrowLeft || e.keyCode === this.keyCodes.delete,
                    s = "" === i.val();
                r && s && a && (this.selectChip(o, a - 1, n), i.blur())
            }), this.$document.on("click", `${this.selectors.chips} ${this.selectors.delete}`, e => {
                const i = t(e.target), n = i.closest(this.selectors.chips), o = i.closest(this.selectors.chip);
                e.stopPropagation(), this.deleteChip(n.data("index"), o.index(), n), n.find("input").focus()
            })
        }, this.deleteSelectedChip = ((t, e, i) => {
            const n = t.data("index"), o = e.index();
            this.deleteChip(n, o, t);
            let a = null;
            o < i - 1 ? a = o : o !== i && o !== i - 1 || (a = i - 1), a < 0 && (a = null), null !== a && this.selectChip(n, a, t), i || t.find("input").focus()
        }), this.selectLeftChip = ((e, i) => {
            const n = i.index() - 1;
            n < 0 || (t(this.selectors.chip).removeClass("selected"), this.selectChip(e.data("index"), n, e))
        }), this.selectRightChip = ((e, i, n) => {
            const o = i.index() + 1;
            t(this.selectors.chip).removeClass("selected"), o > n ? e.find("input").focus() : this.selectChip(e.data("index"), o, e)
        }), this.renderChips = (t => {
            let e = "";
            t.data("chips").forEach(t => {
                e += this.getSingleChipHtml(t)
            }), e += '<input class="input" placeholder="">', t.html(e), this.setPlaceholder(t)
            ...
            const i = t.data("chips");
            for (let t = 0; t < i.length; t++) if (i[t].tag === e.tag) return !1;
            return "" !== e.tag
        }, this.addChip = ((e, i, n) => {
            if (!this.isValid(n, i)) return;
            const o = this.getSingleChipHtml(i);
            n.data("chips").push(i), t(o).insertBefore(n.find("input")), n.trigger("chip.add", i), this.setPlaceholder(n)
        }), this.deleteChip = ((t, e, i) => {
            const n = i.data("chips")[e];
            i.find(".chip").eq(e).remove(), i.data("chips").splice(e, 1), i.trigger("chip.delete", n), this.setPlaceholder(i)
        }), this.selectChip = ((t, e, i) => {
            const n = i.find(".chip").eq(e);
            n && !1 === n.hasClass("selected") && (n.addClass("selected"), i.trigger("chip.select", i.data("chips")[e]))
        }), this.getChipsElement = ((t, e) => e.eq(t)), this.init(), this.eventsHandled || (this.handleEvents(), this.eventsHandled = !0), this)
    }, t.fn.material_chip = t.fn.materialChip
}(jQuery);
var objectFitImages = function () {
    "use strict";
    var t = "bfred-it:object-fit-images", e = /(object-fit|object-position)\s*:\s*([-.\w\s%]+)/g,
        i = "undefined" == typeof Image ? {style: {"object-position": 1}} : new Image, n = "object-fit" in i.style,
        o = "object-position" in i.style, a = "background-size" in i.style, r = "string" == typeof i.currentSrc,
        s = i.getAttribute, l = i.setAttribute, c = !1;
    ...
    function p(e, i) {
        ...
        }, !0), c = !0, e = "img"), i.watchMQ && window.addEventListener("resize", p.bind(null, e, {skipTest: i.skipTest}))
    }

    return p.supportsObjectFit = n, p.supportsObjectPosition = o, function () {
        function e(e, i) {
...
!function (t) {
            ...
            return o(t, [{
                ...
                key: "coverImage", value: function () {
                    var t = this.image.$container.getBoundingClientRect(), e = t.height, i = this.options.speed,
                        n = "scroll" === this.options.type || "scroll-opacity" === this.options.type, o = 0, a = e,
                        r = 0;
                ...
                key: "onScroll", value: function (t) {
                    ...
                    if (this.options.elementInViewport && (a = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = a.bottom >= 0 && a.right >= 0 && a.top <= p && a.left <= h, t || this.isElementInViewport) {
                        var r = Math.max(0, i), s = Math.max(0, n + i), l = Math.max(0, -i), c = Math.max(0, i + n - p),
                            u = Math.max(0, n - (i + n - p)), d = Math.max(0, -i + p - n),
                            f = 1 - 2 * (p - i) / (p + n), m = 1;
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.default = function () {
        ...
        e.prototype.coverImage = function () {
            ...
            if (t && this.video && e && ("IFRAME" === e || "VIDEO" === e)) {
                var i = t.image.height, n = i * this.image.width / this.image.height, o = (t.container.width - n) / 2,
                    r = t.image.marginTop;
    ...
    return t = $.extend({data: {}}, t), this.each(function () {
        const e = $(this);
        let i;
        const n = t.data;
        Object.keys(n).length && (i = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter($(this)), e.on("keyup", t => {
            const o = e.val();
            if (i.empty(), o.length) for (const t in n) if (-1 !== n[t].toLowerCase().indexOf(o.toLowerCase())) {
                const e = $(`<li>${n[t]}</li>`);
                i.append(e)
            }
